  ...
  return (
    <nav className="flex w-full bg-black text-white responsive-padding">
      <ul className="flex flex-1">
        <li className="flex gap-2 px-4 py-2 items-center bg-orange-500 hover:bg-orange-600 select-none cursor-pointer">
          <RxDragHandleHorizontal className="size-6 "/>
          <p className="hidden sm:flex">Categories</p>
        </li>
        <li className="select-none cursor-pointer px-4 py-2 hover:bg-zinc-700/80">Home</li>
